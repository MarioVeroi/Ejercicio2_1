...
public class MainActivity extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        tomarvideo = (Button) findViewById(R.id.btnGrabarVideo);
        guardar = (Button) findViewById(R.id.btnSalvar);
        ...
        guardar.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view){
                if(bArrayVideo != null){
                    ...
                    if(bArrayVideo == null)
                    {
                        Toast.makeText(getApplicationContext(),"Debe grabar un video para guardarlo!", Toast.LENGTH_LONG).show();
                        video.requestFocus();}
                }
            }
        });
    ...
    private void dispatchTakeVideoIntent(){
        ...
        if (takePictureIntent.resolveActivity(getPackageManager()) != null){
            ...
            try {
                ...
                adb.setTitle("Felicidades");
                adb.setMessage("Su video se ha guardado correctamente");
                adb.setPositiveButton("Aceptar", null);
                adb.show();
            } catch (IOException ex) {
                Toast.makeText(getApplicationContext(),"Problema al guardarlo",Toast.LENGTH_LONG).show();
            }
